class Spyder < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://dl.cocoon-ai.com/spyder/0.2.2/spyder-0.2.2-darwin-arm64"
      sha256 "5f5cd5d0792589706748fd3350c3bec11e72e4a0b8b5eccdd2d30dd48fc41276"
    else
      url "https://dl.cocoon-ai.com/spyder/0.2.2/spyder-0.2.2-darwin-amd64"
      sha256 "a117efe1ae0534cfdb3e9ebe3372c47e802534adfeaccd6c3b08d2007a24d801"
    end
  end

  on_linux do
    url "https://dl.cocoon-ai.com/spyder/0.2.2/spyder-0.2.2-linux-amd64"
